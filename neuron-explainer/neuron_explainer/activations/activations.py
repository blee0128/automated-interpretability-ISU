...
class NeuronRecord(FastDataclass):
    ...
    def _get_top_activation_slices(
        ...
        # print("len(self.most_positive_activation_records): {}".format(len(self.most_positive_activation_records)))
    ...
    def train_activation_records(
        ...
        random records.
        """
        print(self._get_top_activation_slices(activation_record_slice_params)["train"])
